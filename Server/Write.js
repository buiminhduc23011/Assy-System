...
plc1.initiateConnection(
  { port: 1002, host: '192.168.1.11', ascii: false },
  connected_plc1
);
...
plc2.initiateConnection(
  { port: 1002, host: '192.168.1.13', ascii: false },
  connected_plc2
);
...
plc3.initiateConnection(
  { port: 1002, host: '192.168.1.15', ascii: false },
  connected_plc3
);
...
plc4.initiateConnection(
  { port: 1002, host: '192.168.1.17', ascii: false },
  connected_plc4
);
...
plc5.initiateConnection(
  { port: 1002, host: '192.168.1.19', ascii: false },
  connected_plc5
);
...
app.post("/api/Control_PLC_2", (req, res) => { plc2_controller(plc2, req, res); });
app.post("/api/Control_PLC_3", (req, res) => { plc3_controller(plc3, req, res); });
app.post("/api/Control_PLC_4", (req, res) => { plc4_controller(plc4, req, res); });
app.post("/api/Control_PLC_5", (req, res) => { plc5_controller(plc5, req, res); });
